...
(function (e, t, n) {
    ...
    if (!t.QHDomain) {
        ...
        i = i ? i[1] : "v320b3", t.QHDomain = {
            popJsPath: "http://s0.qhimg.com/i360/;js;pass_api_/panel,login,reg,name,mail,loginemail,md5,log,mobile/" + i + ".js",
            i360: "http://i.360.cn",
    ...
    e._hostCurr = v && v[0], e.uinfo = {}, e.resConfig = {
        ...
        setNameTitle: "",
        setMailTitle: "",
        afterRenderPanel: null,
        needDefaultSkin: !0,
        afterClosePanel: null,
        loginAfterSetName: !0,
        regType: "email_phone",
        isByqt: !0,
        thirdFun: function (e) {
        ...
        regOpts: {regway: "email", needEmailActive: !0, needName: !0, nickname: !1},
        regPhoneOpts: {regway: "phone", needName: !0, nickname: !1},
        loginOpts: {thirdLogin: ["sina|renren|msn|fetion|Telecom", "", "", ""], captFlag: !0},
        ssoOpts: {},
        bindOpts: {width: 400, title: "\u5b8c\u5584\u5e10\u53f7\u8d44\u6599"},
        namedOpts: {},
        mailOpts: {}
    }, e.thirdLoginSuccess = function () {
        ...
        return i != "CSS1Compat" && (s = e.body, l = s.scrollWidth, c = s.scrollHeight), i && !r && (u = s.clientWidth, o = s.clientHeight), l = Math.max(l, u), c = Math.max(c, o), a = Math.max(a, s.scrollLeft, e.body.scrollLeft), f = Math.max(f, s.scrollTop, e.body.scrollTop), {
            width: u,
            height: o,
            scrollWidth: l,
            scrollHeight: c,
        ...
        if (e.Cookie.get("Q"))if (e.resConfig.reloadAfterLogout) {
            var n = e.resConfig.jumpUrl || location.href;
            location.href = s.login_http + "/?op=logout&destUrl=" + encodeURIComponent(n)
        } else e.loadJsonp(s.login_http + "/?o=sso&m=logout&func=%callback%", e.logoutOtherDomain); else t && t()
        ...
        try {
            ...
            } else e.uinfo = {}, o(".loginWrap").hide(), o(".popUsername").html(""), o(".nloginWrap").show(), o(".btn-logout-pop").un("click", e._btn_logout_handler)
        } catch (r) {
        }
        ...
        if (!e.Cookie._isValidKey(t))return;
        i = i || {};
        var s = i.expires;
        ...
        if (e.Cookie.get("Q") || !e.resConfig.isByqt)if (e.getUserStatus()) t && t(e.uinfo); else {
        ...
        } else n && n(), o(".loginWrap").hide(), o(".nloginWrap").show()
        ...
        if (!e._hostCurr)return;
        for (var o = 0, u = i.length; o < u; o++)i[o].t && (s.expires = i[o].t - r), s.path = "/", s.domain = e._hostCurr, e.Cookie.set(i[o].k, i[o].v, s);
        if (e.resConfig.loginAfterSetName && n.type != "bind" && (!n.userName || n.userName.indexOf("360U") > -1)) e.showSetName(t, {
            notRequest: !0,
            crumb: n.crumb
        }); else if (e.resConfig.loginAfterSetName && n.type == "bind") e.showBind(t, {
            regway: "bind",
            crumb: n.crumb
        }); else {
            e.execCallback(t, n);
    ...
    for (; y < b; y++)g = m[y], e[g] = w[g] = function (t) {
        return function (n, r) {
            e.loadJs(s.popJsPath, function () {
                if (w[t] == e[t])throw new Error("QUC JSAPI [" + s.popJsPath + "] loading exception. Run the [QHPass." + t + "] methods fail.");
                e[t](n, r), delete w[t]
    ...
    e.namedUser = function (t, n) {
        e.resConfig.loginAfterSetName = !0, e.getUserInfo(function (n) {
            n.type != "bind" && (!n.userName || n.userName.indexOf("360U") > -1) ? e.showSetName(t, {
                    notRequest: !0,
                    crumb: n.crumb
                }) : n.type == "bind" ? e.showBind(t, {regway: "bind", crumb: n.crumb}) : e.execCallback(t, n)
        }, function () {
            e.showLogin(t)
        })
        ...
        o(n.body).delegate("#mod_quc_pop a, #mod_quc_pop .quc-psp-gstat", "mousedown", function (n) {
            if (!t.QHPASS_MONITOR)return;
            var r = n.target;
            try {
                var i = {
                    cId: QHPASS_MONITOR.util.getContainerId(r),
                    c: QHPASS_MONITOR.util.getText(r),
                    p: "360_psp_" + e.resConfig.useType
                };
        ...
        if (!t && location.host.indexOf("360.cn") > -1)return;
...
(function (e, t) {
    if (typeof e.QHPASS_MONITOR != "undefined")return;
    var n = "v1.2.7 (2013.04.27)", r = "360.cn", i = function (e, s) {
        ...
        var u = t, a = navigator, f = e.screen, l = o ? "" : t.domain.toLowerCase(), c = a.userAgent.toLowerCase(), h = {
            trim: function (e) {
            ...
            getProject: function () {
                ...
                } else if (e.ActiveXObject && !e.opera)try {
            ...
            getBase: function () {
                ...
                if (!t.type || t.type != "submit" && t.type != "button") {
                    if (n == "AREA")return {f: g.getHref(t), c: "area:" + t.parentNode.name, cId: r};
                    var f, l;
                    return n == "IMG" && (f = t), t = p.parentNode(t, "A"), t ? (l = g.getText(t), {
                            f: g.getHref(t),
                            c: l ? l : f ? f.src.match(/[^\/]+$/) : "",
                            cId: r
                        }) : !1
                ...
                } else s = {f: g.getHref(t), c: g.getText(t), cId: r};
                return s
        ...
        return {
            version: n, util: g, data: y, config: b, sendLog: function () {
                ...
                var e = [], t = 0, n;
                while (n = arguments[t++])v.isArray(n) ? e = e.concat(n) : e.push(n);
